...
export const ENGLAND_BANK_HOLIDAYS = SOURCE_DATA["england-and-wales"].events.map(e => ({
  ...e,
...
export const isBankHoliday = (date) => ENGLAND_BANK_HOLIDAYS.some(holiday => isSameDate(holiday.date, date))
